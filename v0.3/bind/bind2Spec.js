...
describe('bind2, MDN的实现 >', function () {
    ...
    it('Creating a bound function', function () {
        (function () {
            ...
            var boundGetX = retrieveX.bind2(module);
            r = boundGetX(); // 81
            expect(r).toBe(81);
        })();
    });
    ...
    it('Partially applied functions', function () {
        ...
        var leadingThirtysevenList = list.bind2(null, 37);
    ...
    it('With setTimeout', function () {
        ...
        LateBloomer.prototype.bloom = function () {
            window.setTimeout(this.declare.bind2(this), 1000);
        };
